...
import uz.zohidjon.ecommerce.email.EmailService;
import uz.zohidjon.ecommerce.kafka.order.OrderConfirmation;
import uz.zohidjon.ecommerce.kafka.payment.PaymentConfirmation;
import uz.zohidjon.ecommerce.notification.Notification;
import uz.zohidjon.ecommerce.notification.NotificationRepository;

import java.time.LocalDateTime;

import static uz.zohidjon.ecommerce.notification.NotificationType.ORDER_CONFIRMATION;
import static uz.zohidjon.ecommerce.notification.NotificationType.PAYMENT_CONFIRMATION;
